...
object ComponentEntrypoint : WorldComponentInitializer{
    val STARSHIP_COMPONENT: ComponentKey<StarshipWorldComponent> = ComponentRegistryV3.INSTANCE.getOrCreate(identifier("starship_component"), StarshipWorldComponent::class.java)
